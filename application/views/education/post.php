    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-7 co-xs-12 text-left">
                <h3>Post A Education</h3>
            </div>
            <div class="col-md-6 col-sm-5 co-xs-12 text-right">
                <div class="bread">
                    <ol class="breadcrumb">
                        <li><a href="">My Educations</a></li>
                        <li class="active"><a href="">Post Education</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <form class="row" id="post_job" action="" method="post">
                        <div class="col-md-6 col-sm-6 ceol-xs-12">
                            <div class="form-group">
                                <label>Education Title<span style="color:red;">&emsp;*</span></label>
                                <input type="text" placeholder="Education Title" name="title" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6  col-sm-6 ceol-xs-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>Education Category<span style="color:red;">&emsp;*</span></label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label>Education Specification</label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <button class="btn btn-default pull-right" id="publish_job">Publish Education <i class="fa fa-angle-right"></i></button>
                        </div>
                    </form>
                </div>
            </div>
