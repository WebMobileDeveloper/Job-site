            ...
            <div class="col-md-6 col-sm-5 co-xs-12 text-right">
                <div class="bread">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('post/dashboard/active_posts'); ?>">Active Property</a></li>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="single-job-page">
                        ...
                        <div class="heading-inner">
                            <p class="title">Property Specification:</p>
                        </div>
                        <div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <aside>
                        <div class="apply-job">
                            <a class="btn btn-default" href="<?php echo site_url('property/post/getAppliedUsers/'.$post_id); ?>"><i class="fa fa-star"></i>Applied Customers</a>
                        </div>
                        <div class="company-detail">
                            <div class="company-img post-detail-company-logo">
                                <img  src="<?php echo ASSETS_ROOT; ?>profile image/client/logo_image/<?php echo $this->login_user_id?>_property.jpg" alt="Image"
                    ...
                    <div class="widget">
                        <div class="widget-heading"><span class="title">Featured Properties</span></div>
                        <ul class="related-post">
                            <?php
                            foreach ($featured_posts as $row){
                            ?>
                            <li class="categories-list-page">
                                <a href="<?php echo site_url('property/post/post_detail/'.$row->post_id.'/'.$row->user_id); ?>"><?php echo $row->title; ?> </a>
