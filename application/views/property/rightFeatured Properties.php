...
<div class="col-md-8 col-sm-8 col-xs-12">
    <div class="heading-inner first-heading">
        <p class="title">Your Featured Properties</p>
    </div>
        ...
        <?php foreach ($featured_posts as $row) { ?>
            <div class="job-box job-box-2 expire-box ribbon-content">
                ...
                <div class="expire-job-box">
                    <span class="expire-date"> This property will Expire on <strong><?php echo substr($row->expire_date, 0, 10); ?></strong></span>
                </div>
    ...
    <?php if ($total_count > 0) { ?>
        <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
            <div class="pagination-box clearfix">
                ...
                <ul class="pagination">
                    <li>
                        <a href="<?php echo site_url('property/dashboard/featured_posts/' . $before); ?>" aria-label="Previous"> <span aria-hidden="true">«</span> </a>
                    </li>
                    <?php
                    for ($i = $start; $i <= $end; $i++) {
                        ?>
                        <li <?php echo ($i == $page) ? "class='active'" : ""; ?>><a href="<?php echo site_url('property/dashboard/featured_posts/' . $i); ?>"><?php echo $i; ?></a></li>
                    <?php } ?>
                    <li>
                        <a href="<?php echo site_url('property/dashboard/featured_posts/' . $next); ?>" aria-label="Next"> <span aria-hidden="true">»</span> </a>
                    </li>
                </ul>
            </div>
        </div>
