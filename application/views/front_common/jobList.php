        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <h4 class="search-result-text">Showing <?php echo count($result); ?> of <?php echo $total_count; ?> available Post(s)</h4>
                </div>
                        ...
                        foreach ($result as $row) { ?>
                            <div class="job-box">
                                ...
                                <div class="col-md-1 col-sm-1 col-xs-12 hidden-xs hidden-sm">
                                    <div class="comp-logo">
                                        <a href="">
                                            <img class="img-responsive" src="<?php echo ASSETS_ROOT; ?>profile image/client/logo_image/<?php echo $row->user_id; ?>_<?php echo $row->post_type; ?>.jpg" alt="Image"
                                    ...
                                    <div class="job-title-box">
                                        ...
                                        if ($this->login_user_id) {
                                            if ($this->login_user_type == 'customer' || $this->login_user_id != $row->user_id) {
                                                echo site_url('customer/'.$row->post_type.'/user_post_detail/' . $row->post_id . '/' . $row->user_id . "/" . $this->login_user_id);
                                            } else {
                                                echo site_url($row->post_type.'/post/post_detail/' . $row->post_id . '/' . $row->user_id);
                                            }
                                        } else {
                                            echo site_url('home/user_post_detail/' . $row->post_id . '/' . $row->user_id);
                                        }
                                        ?>
                                        ">
                    ...
                    <?php if ($total_count > 0) { ?>
                        <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                            <div class="pagination-box clearfix">
                                ...
                                <ul class="pagination">
                                    <li>
                                        <a href="<?php echo site_url('home/search_job/' . $before); ?>" aria-label="Previous"> <span aria-hidden="true">«</span> </a>
                                    </li>
                                    <?php
                                    for ($i = $start; $i <= $end; $i++) {
                                        ?>
                                        <li <?php echo ($i == $page) ? "class='active'" : ""; ?>><a href="<?php echo site_url('home/search_job/' . $i); ?>"><?php echo $i; ?></a></li>
                                    <?php } ?>
                                    <li>
                                        <a href="<?php echo site_url('home/search_job/' . $next); ?>" aria-label="Next"> <span aria-hidden="true">»</span> </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
