                                ...
                                <li class="categories-list-page">
                                    ...
                                    if ($this->login_user_id) {
                                        if ($this->login_user_type == 'customer' || $this->login_user_id != $row->user_id) {
                                            echo site_url('customer/'.$post_detail->post_type.'/user_post_detail/' . $row->post_id . '/' . $row->user_id . "/" . $this->login_user_id);
                                        } else {
                                            echo site_url($post_detail->post_type.'/post/post_detail/' . $row->post_id . '/' . $row->user_id);
                                        }
                                    } else {
                                        echo site_url('customer/'.$post_detail->post_type.'/user_post_detail/' . $row->post_id . '/' . $row->user_id);
                                    }
