        ...
        <?php foreach ($active_posts as $row) { ?>
            <div class="job-box job-box-2">
                <div class="col-md-2 col-sm-2 col-xs-12 hidden-xs hidden-sm">
                    <div class="comp-logo">
                        <a href=""><img src="<?php echo ASSETS_ROOT; ?>profile image/client/logo_image/<?php echo $this->login_user_id ?>_job.jpg" alt="Image"
                                        onerror="this.src = '<?php echo ASSETS_ROOT; ?>images/company-logo/default.png'" class="img-responsive center-block"> </a>
                    </div>
                </div>
                <div class="col-md-10 col-sm-10 col-xs-12">
                    <div class="job-title-box">
                        <a href="<?php echo site_url('job/post/post_detail/'.$row->post_id.'/'.$row->user_id); ?>">
    ...
    <?php if ($total_count > 0) { ?>
        <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
            <div class="pagination-box clearfix">
                ...
                <ul class="pagination">
                    <li>
                        <a href="<?php echo site_url('job/dashboard/active_posts/'.$before); ?>" aria-label="Previous"> <span aria-hidden="true">«</span> </a>
                    </li>
                    <?php
                    for ($i = $start; $i <= $end; $i++) {
                        ?>
                        <li <?php echo ($i == $page) ? "class='active'" : ""; ?>><a href="<?php echo site_url('job/dashboard/active_posts/'.$i); ?>"><?php echo $i; ?></a></li>
                    <?php } ?>
                    <li>
                        <a href="<?php echo site_url('job/dashboard/active_posts/'.$next); ?>" aria-label="Next"> <span aria-hidden="true">»</span> </a>
                    </li>
                </ul>
            </div>
        </div>
