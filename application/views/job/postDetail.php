        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-5 co-xs-12 text-right">
                <div class="bread">
                    <ol class="breadcrumb">
                        <li><a href="#">Job</a></li>
                        <li><a href="<?php echo site_url('job/dashboard/active_posts'); ?>">Active Jobs</a></li>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                    ...
                    <div class="single-job-page">
                        <div class="job-short-detail">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                <dl>
                                    <dt>Job Type:</dt>
                                    <dd><?php echo $this->job_types[$post_detail->type]; ?> Job</dd><div class="clearfix"></div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <aside>
                        <div class="apply-job">
                            <a class="btn btn-default" href="<?php echo site_url('job/post/getAppliedUsers/'.$post_id); ?>"><i class="fa fa-star"></i>Applied Customers</a>
                        </div>
                        <div class="company-detail">
                            <div class="company-img">
                                <img  src="<?php echo ASSETS_ROOT; ?>profile image/client/logo_image/<?php echo $this->login_user_id?>_job.jpg" alt="Image"
                    ...
                    <div class="widget">
                        ...
                        <ul class="related-post">
                            ...
                            <li class="categories-list-page">
                                <a href="<?php echo site_url('job/post/post_detail/'.$row->post_id.'/'.$row->user_id); ?>"><?php echo $row->title; ?> </a>
