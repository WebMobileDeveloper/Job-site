                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <ul class="nav panel-tabs">
                                <li class="active"><a href="#tab0" data-toggle="tab"><i class="icofont icon-ribbon"></i><span class="hidden-xs hidden-sm">By Company</span></a></li>
                                <li><a href="#tab1" data-toggle="tab"><i class="icofont icon-layers"></i><span class="hidden-xs hidden-sm">By Function</span></a></li>
                                <li><a href="#tab2" data-toggle="tab"><i class="icofont icon-global"></i><span class="hidden-xs hidden-sm">By City</span></a></li>
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            ...
                            for ($i = 0; $i < 5; $i++) { ?>
                                ...
                                foreach ($postData[$indexArr[$i]] as $post) { ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                        <div class="job-box">
                                            <div class="col-md-1 col-sm-1 col-xs-12 nopadding hidden-xs hidden-sm">
                                                <div class="comp-logo"><img src="<?php echo ASSETS_ROOT; ?>images/company/<?php echo $i; ?>.png" class="img-responsive" alt="scriptsbundle"></div>
                                            </div>
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <div class="job-title-box">
                                                    ...
                                                    <a href="#"><span class="comp-name"><?php echo $post->company_name . "   " . $post->location; ?> </span></a>
                                                </div>
                                            </div>
                            ...
                            <!--
                            <div class="tab-pane animated fadeInDown" id="tab1">
                                <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                    <div class="job-box">
                                        <div class="col-md-1 col-sm-1 col-xs-12 nopadding hidden-xs hidden-sm">
                            ...
                            <div class="tab-pane animated fadeInLeft" id="tab2">
                                <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                    <div class="job-box">
                                        <div class="col-md-1 col-sm-1 col-xs-12 nopadding  hidden-xs hidden-sm">
                                            <div class="comp-logo"><img src="<?php /*echo ASSETS_ROOT; */ ?>images/company/5.png"
