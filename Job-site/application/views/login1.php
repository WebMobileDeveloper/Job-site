        ...
        <script>
            $(document).ready(function () {
                ...
                $(".signin_btn").click(function () {
                    ...
                    $.post(
                            '<?php echo site_url('admin/auth/login') ?>', {email: email, password: password},
                            function (result) {
                                if (result.status == "ok") {
                                    location.href = "<?php echo site_url('amdin/home')?>";
                                }else{
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form action="<?php echo site_url("admin/auth/login") ?>" id="signinform" method="post">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-xs-4">
                            <button type="button" class="btn btn-primary btn-block btn-flat signin_btn">Sign In</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
                ...
                <!--<a href="<?php echo site_url("admin/auth/index/register")?>" class="text-center">Register a new membership</a>-->
